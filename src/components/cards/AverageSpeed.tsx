...
export const AverageSpeed = (props:AverageSpeedProps): JSX.Element => {
    return (
        <Card className="average-speed" style={props.rmBackground ? {backgroundColor:"transparent",boxShadow:"none"}: {}} bodyStyle={props.rmBackground ?{padding:0}:{}}>
            ...
            <Row>
                ...
                <Col md={12} className="chart-area-1"><CustomGauge percentage={props.speedRate} type="speed-rate" height={90} /></Col>
                <Col md={6} className="chart-area-2">
