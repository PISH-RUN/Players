...
import { Button, Card, Checkbox, Col, DatePicker, Form, Input, InputNumber, PageHeader, Radio, Row } from 'antd';
...
const Setting: FC = () => {
  ...
  const handleSubmit = async (values: any) => {
    await updateMe({
      ...
      birthdate: moment(`${values.year}-${values.month}-${values.day}`, 'jYYYY-jMM-jDD')
        .locale('en')
        .format('YYYY-MM-DD'),
      day: undefined,
      month: undefined,
