...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserOutput', id: number, username: string, password?: string | null | undefined, lastLogin: any, token: string } };
