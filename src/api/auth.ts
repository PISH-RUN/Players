...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginOutput', id: number, username: string, password?: string | null | undefined, lastLogin?: any | null | undefined, token: string } };
