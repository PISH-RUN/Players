...
export type GetAbilitiesQueryVariables = Types.Exact<{
  take?: Types.InputMaybe<Types.Scalars['Int']>;
  skip?: Types.InputMaybe<Types.Scalars['Int']>;
}>;


export type GetAbilitiesQuery = { __typename?: 'Query', abilities: Array<{ __typename?: 'Ability', id: number, name: string, examTime?: number | null | undefined, questionCount?: number | null | undefined, hardMinimum?: number | null | undefined, easyMinimum?: number | null | undefined, year?: string | null | undefined }> };


export const GetAbilitiesDocument = `
    query GetAbilities($take: Int, $skip: Int) {
  abilities(take: $take, skip: $skip) {
    id
    name
    examTime
    questionCount
    ...
    `;
export const useGetAbilitiesQuery = <
      TData = GetAbilitiesQuery,
      TError = unknown
    >(
      variables?: GetAbilitiesQueryVariables,
      options?: UseQueryOptions<GetAbilitiesQuery, TError, TData>
    ) =>
    useQuery<GetAbilitiesQuery, TError, TData>(
      variables === undefined ? ['GetAbilities'] : ['GetAbilities', variables],
      fetcher<GetAbilitiesQuery, GetAbilitiesQueryVariables>(GetAbilitiesDocument, variables),
      options
    );